...
class Courses extends CI_Controller {
	...
	public function index()
	{
		...
		if($this->input->post('first_name')){
			...
			$allData['module'] = $this->Common_model->getAllDataOrder('module', array('course_id' => $courseId ),'module_name','ASC');
			$data['content'] = $this->load->view('site/courses/list',$allData, true);
			$this->load->view('template/site/main-afterlogin',$data);
		}
	...
	public function start()
	{
		...
		if($this->input->post('first_name')){
			...
			$data['content'] = $this->load->view('site/courses/start',$allData, true);
			$this->load->view('template/site/main-afterlogin',$data);
		}
