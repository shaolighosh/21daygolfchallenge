...
class User_share extends CI_Controller {
	...
	public function index()
	{
        ...
        $allData['userVideos'] = $this->Common_model->getAllData('golfersu_userstep_video',array('user_id' =>$userId,'step' => $stepId ));
        if(empty($allData['userVideos'])){
            redirect('/');
        }
        $data['content'] = $this->load->view('site/share/share',$allData, true);
