    ...
    <fieldset class="custom-field">
      ...
      <div class="card das_warp">
        <div class="card-body">
          ...
          <h2 class="efri-text">Internal Community</h2>
...
<div class="row mb60">
    ...
    <?php if(!empty($userVideos)){
      ...
      <input type="hidden" name="share_video_id" value="<?php echo $userVideo->id;?>">
      ...
      <source src="<?php echo base_url();?><?php echo $userVideo->video_file;?>" type="video/mp4"></source>
        ...
        <div class="viw_ago"><a class="voteUser" href="javascript:void(0)">Click here to vote</a></div>
