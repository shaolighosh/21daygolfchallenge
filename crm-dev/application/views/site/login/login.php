                  ...
                  <form method="POST" action="<?php echo site_url('login');?>" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="email" class="form-control" id="yourUsername" value="<?php if($this->input->cookie('remember_email',true)){ echo $this->input->cookie('remember_email',true); }?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" value="<?php if($this->input->cookie('remember_password',true)){ echo $this->input->cookie('remember_password',true); }?>" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember" <?php if($this->input->cookie('remember_email',true)){ ?> checked <?php }?> value="true" id="rememberMe">
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                      <p class="small mb-0"><a href="<?php echo site_url();?>/login/forget-password">Forget Password </a></p>
                    </div>
