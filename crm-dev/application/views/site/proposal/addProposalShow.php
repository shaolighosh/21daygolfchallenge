                              ...
                              <div class="row">
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <div class="form-inner">
                                          ...
                                          <input type="text" id="customer_no" disabled class="form-control" name="customer_no" value="<?php echo $proposal->customer_no;?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="lname">Customer's First Name:</label>
                                        <input type="text" id="customer_name" disabled name="customer_first_name" class="form-control" value="<?php echo $proposal->first_name;?>">
                                    </div>
                                    <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="lname">Customer's Last Name:</label>
                                        <input type="text" id="customer_last_name" disabled name="customer_last_name" class="form-control" value="<?php echo $proposal->last_name;?>">
                                    </div>
                                    <!-- <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Customer No :</label>
                                  ...
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Phone Number :</label>
                                        <input type="text" class="form-control" disabled id="phone_number" name="phone_number" value="<?php echo $proposal->phone;?>">
                                    </div>
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Email :</label>
                                        <input type="text" class="form-control" disabled id="email" name="email" value="<?php echo $proposal->email;?>">
                                    </div>
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Address :</label>
                                        <input type="text" class="form-control" disabled id="address" name="address" value="<?php echo $proposal->address;?>">
                                    </div>
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Street Address :</label>
                                        <input type="text" class="form-control" disabled id="street_address" name="street_address" value="<?php echo $proposal->street_address;?>">
                                    </div>
                                  <!-- <div class="col-sm-6 col-md-6 mb-3">
                                  ...
                                  <div class="col-sm-6 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" disabled id="city" name="city" value="<?php echo $proposal->city;?>">
                                    </div>
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">State / Province :</label>
                                    <input type="text" class="form-control" disabled id="state" name="state" value="<?php echo $proposal->state;?>">
                                    </div>
                                  <div class="col-sm-6 col-md-6 mb-3">
                                      <label for="fname">Postal / Zip Code :</label>
                                        <input type="text" class="form-control" disabled id="postal" name="postal" value="<?php echo $proposal->zip_code;?>">
                                    </div>
                                  <!-- <div class="col-sm-6 col-md-6 mb-3">
                                    ...
                                    <div class="col-sm-6 col-md-6 mb-3">
                                      ...
                                      <select name="individual_discount" disabled class="form-control">
                                      ...
                                      <select name="discount" class="form-control" disabled>
                                        <option value="">None</option>
                              ...
                              <form>
                                  <table class="table table-bordered custom-table">
                                            ...
                                            <input type="hidden" name="all_service_id[]" value="<?php echo $service->id;?>">
                                              ...
                                              <td class="text-center">
                                                  <div class="form-check">
                                                      <input class="form-check-input" disabled type="checkbox" <?php if(!empty($serviceAddData)){ if($serviceAddData->recommended == 'yes'){ echo "checked";} }?>  name="recommended[]" value="<?php echo $service->id;?>">
                                                    </div>
                                              </td>
                                              <td class="text-center">
                                                  <div class="form-check">
                                                      <input class="form-check-input" disabled type="checkbox" <?php if(!empty($serviceAddData)){ if($serviceAddData->optional == 'yes'){ echo "checked";} }?> name="optional[]" value="<?php echo $service->id;?>">
                                                    </div>
                                              </td>
                                              <td>
                                                  <input class="form-control" type="text" disabled  name="size[]" value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->size_time; } else{echo $sizeData;}?>">  
                                              </td>
                                              <td>
                                                  <input class="form-control" type="number" disabled min="1" max="<?php echo $service->total_service;?>" name="number_of_services[]" value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->service_number_service; }?>">
                                              </td>
                                              <td>
                                                  
                                                    <input class="form-control" type="number" disabled   name="number_of_services_fy[]" value="<?php echo $service->total_service;?>">
                                                  
                                              </td>
                                              <td>
                                                  <input type="text" class="form-control" disabled name="system_unit_price[]" value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->system_price_unit; } else{ echo $service->service_min_price; }?>" placeholder="">
                                              </td>
                                              <td class="text-center">
                                                  <div class="form-check">
                                                      <input class="form-check-input"  disabled type="checkbox" id="check1" name="price_over_write" value="">
                                                    </div>
                                              </td>
                                              ...
                                              <td class="unitPrice"><input type="text" class="form-control" value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->unit_price; }?>"  disabled name="unit_price[]" class="unitPrice"></td>
                                              <td class="totalThisYear"><input type="text" class="form-control"  disabled value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->total_this_year; }?>"  name="total_this_year[]" class="totalThisYear"></td>
                                              <td class="totalFullYear"><input type="text" class="form-control"  disabled value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->total_full_year; }?>"  name="total_full_year[]" class="totalFullYear"></td>
                                          </tr>
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="all_service_id[]" value="<?php echo $service->id;?>">
                                              ...
                                              <td>
                                                    ...
                                                    <input class="form-control" type="number" disabled readonly   name="number_of_services_fy[]" value="<?php echo $service->total_service;?>">
                                              ...
                                              <td class="unitPrice"><input type="text" class="form-control"  disabled value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->unit_price; }?>"  readonly name="unit_price[]" class="unitPrice"></td>
                                              <td class="totalThisYear"><input type="text" class="form-control" disabled  readonly value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->total_this_year; }?>"  name="total_this_year[]" class="totalThisYear"></td>
                                              <td class="totalFullYear"><input type="text" class="form-control"  disabled readonly value="<?php if(!empty($serviceAddData)){ echo $serviceAddData->total_full_year; }?>"  name="total_full_year[]" class="totalFullYear"></td>
                                          </tr>
                                      <?php } } }?>
                                      ...
                                      <?php if(!empty($services)){
                                        ...
                                        <tr>
                                            <td>
                                            <input type="checkbox" name="service_id[]" disabled value="<?php echo $service->id;?>">
                                            <input type="hidden" name="all_service_id[]" value="<?php echo $service->id;?>">
                                            </td>
                                              <td><?php echo $service->program_service;?></td>
                                              <td><?php echo $service->service_name;?></td>
                                              ...
                                              <td class="text-center">
                                                  <div class="form-check">
                                                      <input class="form-check-input" type="checkbox" disabled id="check1" name="price_over_write" value="">
                                                    </div>
                                              </td>
                                              <td class="discount"></td>
