            ...
            <div class="table-responsive">
                ...
                <?php /*if(!empty($userVideos)){
                  foreach($userVideos as $userVideo){
                    ...
                    <input type="hidden" value="<?php echo $userVideos->id;?>" name="external_video_id">
                    <!-- <span>Step <?php echo $userVideos->step;?></span> -->
                    <span class="sharevd">
                    <video class="externamShare" width="300" height="300" controls>
                        <source src="<?php echo base_url();?><?php echo $userVideos->video_file;?>" type="video/mp4">
