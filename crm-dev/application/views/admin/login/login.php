...
<?php if($this->session->flashdata('error')){?>
          ...
          <?php } ?>
                  <form method="POST" action="<?php echo site_url('admin/login');?>" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"> <a href="<?php echo site_url();?>/admin/login/forgetpassword">Forget your password?</a></p>
                    </div>
                  </form>
