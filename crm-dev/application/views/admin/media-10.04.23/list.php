                                              ...
                                              ?>
                                                ...
                                                <td>
                                                    <ul class="settingBtnSec">
                                                        <li><a href="<?php echo base_url(); ?>admin/media-management/view/<?php echo $a.'/'.$userValue->id; ?>" class="editBtn"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                                        <li><a onclick="return confirm('Are you sure want to delete?');" href="<?php echo base_url(); ?>admin/media-management/delete/<?=$userValue->id?>" class="deleteBtn"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                </td> 
                                            </tr>
                                             <?php } }else{ ?>
