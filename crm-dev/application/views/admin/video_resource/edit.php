...
<div class="stap_top__wrapper">
  <form id="msform" method="post" action="<?php echo site_url(); ?>/admin/video-management/edit">
    <fieldset class="custom-field">
      <div class="card das_warp">
        <div class="card-body">
          <a href="<?php echo site_url(); ?>/admin/video-management" class="ar_row"><img src="<?php echo base_url();?>public/assets/img/arrow.jpg"></a>
                             ...
                             <?php 
                              ...
                              ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="video_file" placeholder="Enter Video URL" required><?php echo $videoDetails->video_file; ?></textarea>
                                ...
                                <input type="hidden" name="resourceId" value="<?php echo $videoDetails->id; ?>">
