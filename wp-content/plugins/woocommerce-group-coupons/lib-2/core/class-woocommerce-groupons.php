...
class WooCommerce_Groupons {
	...
	public static function check_dependencies( $disable = false ) {
		...
		if ( !$woocommerce_is_active ) {
			self::$admin_messages[] = "<div class='error'>" . __( '<em>WooCommerce Group Coupons</em> needs the <a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a> plugin. Please install and activate it.', 'woocommerce-group-coupons' ) . "</div>";
		}
		if ( !$woocommerce_is_active ) {
			if ( $disable ) {
