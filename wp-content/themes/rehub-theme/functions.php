...
if ( !defined( 'RH_MAIN_THEME_VERSION' ) ) {
	define('RH_MAIN_THEME_VERSION', '15.6');
}
...
add_action( 'woocommerce_before_cart_collaterals', 'njengah_cart_code', 10 );

function njengah_cart_code( ) {

echo '<div style="color: red; font-size: 13px;">[<strong>Accommodation Fee</strong> is used to operate the <strong>GolfersU</strong> site and accompanying tools. Members can receive a discount up to 100% of site fees. For membership information <a href="/register" target="_blank">Click here</a>]</div><br/>';

}

add_action( 'woocommerce_review_order_before_payment', 'njengah_checkout_code', 10 );

function njengah_checkout_code( ) {
